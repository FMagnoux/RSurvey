         ...
         <main class="mdl-layout__content">
            <div class="page-content">
               <div class="homepage-landing-section mdl-typography--text-center">
                  <div class="logo-font homepage-slogan">Ecoutez la voix de la région</div>
                  <div class="logo-font homepage-sub-slogan">R Survey vous permet de créer des sondages et d'avoir les résultats régions par régions.</div>
