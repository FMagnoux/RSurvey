...
$(document).ready(function() {
  ...
  $('#login').click(function(event) {event.preventDefault();showDialog({ title: "<span class='mdl-color-text--blue-800'>Se connecter</span>", text:contentLogin, negative:false, positive: { title: 'Se connecter', onClick: function () { loginRequest(); } } });});

  $('#signup').click(function(event) {event.preventDefault();showDialog({ title: "<span class='mdl-color-text--blue-800'>Créer un compte</span>", text:contentSignup, negative:false, positive: { title: 'Créer un compte', onClick: function () { signupRequest(); } } });});
